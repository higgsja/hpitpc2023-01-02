...
public abstract class NotesAddEditFormAbstractVL1
    extends ViewBaseVL
    implements BeforeEnterObserver
{
    ...
    public NotesAddEditFormAbstractVL1()
    {
    ...
    public void doLayout()
    {
        ...
        this.notesModel.getBinder()
            ...
            .bind(NoteModel::getAction, NoteModel::setActionInt);
        ...
        this.notesModel.getBinder()
            .forField(this.alert)
            .bind(NoteModel::getTrigger, NoteModel::setTriggerInt);
