...
//    FilterFinVizInfo gridFilter;
    ...
    {
        this.addClassName("dataEquitiesStocksController");
...
//        this.setCheckboxSkipValue(this.dataEquitiesStocksModel.getSelectedSkip());
//
//        this.setCheckboxEquitiesdValue(this.dataEquitiesStocksModel.getSelectedEquitiesd());
...
//
//        this.dataEquitiesStocksModel.getPrefs();
//
...
//    }
    ...
    public void beforeEnter(BeforeEnterEvent event)
    {
        ...
        this.dataEquitiesStocksModel.updateGridData();
