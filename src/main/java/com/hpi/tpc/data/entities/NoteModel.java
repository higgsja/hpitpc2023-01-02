...
//    public static final String SQL_GET_TKR_STRING;
    ...
    @Builder.Default private String units = "0";
    ...
    public NoteModel(String joomlaId, Long tStamp, String ticker,
        String iPrice, String description, String notes, String units,
        String action, String triggerType, String trigger, String active,
        String dateEntered, String high, String low, String close,
        String priceChange, String pctPriceChange,
        String gain, String gainPct, String atr, String earnDate) {
